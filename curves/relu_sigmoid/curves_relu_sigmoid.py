...
if __name__ == '__main__':
    ...
    if not os.path.exists("net_init_curves_relu_sigmoid.pt"):
        net_init.apply(weights_init_sparse)
        torch.save(net_init.state_dict(), "net_init_curves_relu_sigmoid.pt")
    else:
        net_init.load_state_dict(torch.load("net_init_curves_relu_sigmoid.pt"))
    ...
    np.savez("{}_{}_ae_curves".format(lam_max,step)+'_relu_sigmoid_final.npz', loss_all = loss_all,
