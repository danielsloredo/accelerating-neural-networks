...
if __name__ == '__main__':
    ...
    if not os.path.exists("net_init_curves_3_layer_tanh.pt"):
        net_init.apply(weights_init_sparse)
        torch.save(net_init.state_dict(), "net_init_curves_3_layer_tanh.pt")
    else:
        net_init.load_state_dict(torch.load("net_init_curves_3_layer_tanh.pt"))
    ...
    np.savez("{}_{}_ae_curves".format(lam_max,step)+'_3_layer_tanh_final.npz', loss_all = loss_all,
